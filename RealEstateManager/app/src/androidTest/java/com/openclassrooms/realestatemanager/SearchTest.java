...
public class SearchTest {
    ...
    public void searchTest() {
        ...
        ViewInteraction appCompatSpinner = onView(
                allOf(withId(R.id.spinner_house),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.search_rv),
                                        0),
                                0),
                        isDisplayed()));
        ...
        ViewInteraction appCompatButton = onView(
                allOf(withId(R.id.delete_account_btn), withText("Search"),
                        childAtPosition(
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.house_title), withText("Field"),
                        childAtPosition(
                                childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textView.check(matches(withText("Field")));
    }
